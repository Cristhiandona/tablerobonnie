...
var malo = function (x, y) {
  ...
  this.retraso = 15;//Velocidad del Enemigo
  this.fotograma = 0;
...
var jugador = function () {
  ...
  this.victoria = function () {
    ...
    window.location.href = "nivel4.html"; // Cambia a la página del siguiente nivel
  };
